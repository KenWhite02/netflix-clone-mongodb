  ...
  return (
    <div className="group bg-zinc-900 col-span relative h-[12vw]">
      <img
        ...
        alt="Thumbnail"
        className="cursor-pointer object-cover transition duration-[1000ms] shadow-xl rounded-md group-hover:opacity-90 sm:group-hover:opacity-0 w-full h-[12vw]"
      />
      ...
      <div className="opacity-0 absolute top-0 transition duration-200 z-10 invisible sm:visible delay-300 w-full scale-0 group-hover:scale-110 group-hover:-translate-y-[6vw] group-hover:opacity-100">
        <img
          src={data.thumbnailUrl}
          alt="Thumbnail"
          className="cursor-pointer object-cover transition duration-[1ms] shadow-xl rounded-t-md w-full h-[12vw]"
        />
